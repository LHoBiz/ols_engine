...
from . import TO
from . import Circ
from . import CAAP92App
from . import CAAP92Trans
from . import Conl
from . import OHS
from . import ObsData
class dataInput:
    def __init__(self, name):
        ...
        accur    = 100 # input("Insert size of surface cells in metres (i.e. enter a, such that cell = a*a): ")
        colour = "19ff0011"
